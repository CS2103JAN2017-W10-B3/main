...
public class ParserUtilTest {
    ...
    public void executeIsMultipleValidIndex() {
        ...
        assertTrue(ParserUtil.isMultipleValidIndex("6-3"));
        assertTrue(ParserUtil.isMultipleValidIndex("e99-3"));
        assertTrue(ParserUtil.isMultipleValidIndex("f101-3"));
        assertTrue(ParserUtil.isMultipleValidIndex("d4-3"));
        ...
        assertFalse(ParserUtil.isMultipleValidIndex("0"));
