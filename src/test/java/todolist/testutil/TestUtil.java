        ...
        try {
            ...
            return new Task[] {
                    ...
                    new Task(new Title("DBS Internship interview"), new Venue("Raffles Place"),
                            new StartTime("March 31, 9:30"),
                            new EndTime("Wednesday 12:00"), new UrgencyLevel("3"), new Description("I love interview"),
                            new UniqueTagList()),
                    new Task(new Title("Hang out with Joe"), new Venue("313 Somerset"), new StartTime("Saturday 11:00"),
                            new EndTime("Saturday 17:00"), new UrgencyLevel("2"), new Description("I love Joe"),
                            new UniqueTagList()),
                    new Task(new Title("Statistics society meeting"), new Venue("S16 04-30"),
                            new StartTime("Every Wednesday 19:00"),
                            new EndTime("Wednesday 21:00"), new UrgencyLevel("1"), new Description("I love meeting"),
                            new UniqueTagList()),
                    new Task(new Title("Tuition part-time job"), new Venue("Jun Wei's house at Jurong Ease Avenue 1"),
                            new StartTime("Next Thursday 19:00"),
                            new EndTime("Thursday 21:00"), new UrgencyLevel("2"), new Description("I love Part-time"),
                            new UniqueTagList()),
                    new Task(new Title("Strings ensemble rehearsal"), new Venue("UCC hall"),
                            new StartTime("Friday 9:00"),
                            new EndTime("Friday 17:00"), new UrgencyLevel("1"), new Description("I love rehearsal"),
                            new UniqueTagList()),
                    new Task(new Title("Dinner with auntie"), new Venue("Home"), new StartTime("Friday 19:00"),
                            new EndTime("Friday 20:00"), new UrgencyLevel("2"), new Description("I love auntie"),
                            new UniqueTagList()),
                    new Task(new Title("MA3269 Quiz"), new Venue("LT26"), new StartTime("Thursday 12:00"),
                            new EndTime("Thursday 14:00"), new UrgencyLevel("2"), new Description("I hate quiz"),
                            new UniqueTagList()),
                    new Task(new Title("Submit FIN3101 Tutorial"), new Venue("Biz1-0748 Prof Tan's office"),
                            new StartTime("now"),
                            new EndTime("Thursday 11am"), new UrgencyLevel("2"), new Description("I love fanbingbing"),
                            new UniqueTagList()) };
