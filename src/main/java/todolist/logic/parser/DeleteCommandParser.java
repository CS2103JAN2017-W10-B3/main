...
public class DeleteCommandParser {
    ...
    public Command parse(String args) {
        ...
        deleteTaskDescriptor.setStartTime(argsTokenizer.getValue(PREFIX_VENUE).isPresent());
        ...
        deleteTaskDescriptor.setDescription(argsTokenizer.getValue(PREFIX_URGENCYLEVEL).isPresent());
